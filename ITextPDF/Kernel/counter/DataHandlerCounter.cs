...
namespace IText.Kernel.Counter {
    ...
    public class DataHandlerCounter<T, V> : EventCounter, IDisposable
        ...
        /// <see cref="UnknownContext.PERMISSIVE"/>
        /// fallback context.
        /// </summary>
        ...
        /// invocation the
        /// <see cref="DataHandlerCounter{T, V}.OnEvent(IEvent, IMetaInfo)
        ///     "/>
        /// method would throw
        /// an exception.
        /// </remarks>
        public virtual void Close() {
            closed = true;
            try {
                EventDataHandlerUtil.DisableShutdownHooks(dataHandler);
                EventDataHandlerUtil.DisableTimedProcessing(dataHandler);
            }
            finally {
