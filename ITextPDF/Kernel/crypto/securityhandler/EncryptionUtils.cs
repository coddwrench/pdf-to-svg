...
namespace IText.Kernel.Crypto.Securityhandler {
    internal sealed class EncryptionUtils {
        ...
        internal static byte[] FetchEnvelopedData(object certificateKey, object certificate, PdfArray recipients) {
   ...
   //             try {
   //                 var recipient = recipients.GetAsString(i);
   //                 var data = new CmsEnvelopedData(recipient.GetValueBytes());
   ...
   //         return envelopedData;
        ...
        internal static byte[] CipherBytes(X509Certificate x509Certificate, byte[] abyte0, object algorithmidentifier) {
	        throw new NotImplementedException();

			//var cipher = CipherUtilities.GetCipher(algorithmidentifier.ObjectID);
		...
		internal static CultureInfo GetStandartEnUsLocale() {
            var locale = (CultureInfo) CultureInfo.InvariantCulture.Clone();
            //                          en-US                        Invariant
            //=====================     ==================           ==================
            //Currency Symbol           $                            
