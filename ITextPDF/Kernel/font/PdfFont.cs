...
namespace IText.Kernel.Font {
    public abstract class PdfFont : PdfObjectWrapper<PdfDictionary> {
        ...
        [Obsolete]
        protected internal static readonly double[] DEFAULT_FONT_MATRIX = { 0.001, 0, 0, 0.001, 0, 0 };
        ...
        public virtual IList<string> SplitString(string text, float fontSize, float maxWidth) {
            ...
            for (var i = 0; i < text.Length; i++) {
                ...
                var currentCharWidth = GetWidth(ch, fontSize);
        ...
        /// <seealso cref="PdfDocument.FindFont(System.String, System.String)"/>
        /// <seealso cref="FontProgram.IsBuiltWith(System.String)"/>
        /// <seealso cref="FontEncoding.IsBuiltWith(System.String)"/>
        /// <seealso cref="CMapEncoding.IsBuiltWith(System.String)"/>
        ...
        protected internal virtual PdfStream GetPdfFontStream(byte[] fontStreamBytes, int[] fontStreamLengths) {
            ...
            var fontStream = new PdfStream(fontStreamBytes);
            MakeObjectIndirect(fontStream);
            for (var k = 0; k < fontStreamLengths.Length; ++k) {
        ...
        [Obsolete(@"The logic has been moved to iText.IO.Font.TrueTypeFont .")]
