...
namespace IText.Kernel.Colors {
    public class PatternColor : Color {
        ...
        public PatternColor(PdfPattern.Tiling uncoloredPattern, PdfSpecialCs.UncoloredTilingPattern uncoloredTilingCS
            ...
            pattern = uncoloredPattern;
            underlyingColor = MakeColor(uncoloredTilingCS.GetUnderlyingColorSpace(), colorValue);
        }
        ...
        [Obsolete(@"To be removed in iText 7.2. In order to change pattern one shall create a new PatternColor ."
            )]
