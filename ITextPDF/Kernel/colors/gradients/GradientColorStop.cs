...
namespace IText.Kernel.Colors.Gradients {
    ...
    public class GradientColorStop {
        ...
        public GradientColorStop(GradientColorStop gradientColorStop, double offset, 
        ...
        public virtual OffsetType GetOffsetType() {
            return offsetType;
        }
        ...
        public virtual HintOffsetType GetHintOffsetType() {
        ...
        /// instance
        /// </returns>
        public virtual GradientColorStop SetOffset(double offset, OffsetType
             offsetType) {
        ...
        /// instance
        /// </returns>
        public virtual GradientColorStop SetHint(double hintOffset, HintOffsetType
             hintOffsetType) {
        ...
        public override int GetHashCode() {
            var result = JavaUtil.ArraysHashCode(opacity, offset, hintOffset);
        ...
        private static float[] CopyRgbArray(float[] toCopy) {
            ...
            return new[] { Normalize(toCopy[0]), Normalize(toCopy[1]), Normalize(toCopy[2]) };
        }
