...
namespace IText.Kernel.Pdf.Annot {
    ...
    public class PdfLineAnnotation : PdfMarkupAnnotation {
        ...
        /// <see cref="PdfAnnotation.SetRectangle(PdfArray)"/>.
        /// </param>
        /// <param name="line">
        ...
        /// instance.
        /// </returns>
        public virtual PdfLineAnnotation SetBorderStyle(PdfDictionary borderStyle) {
        ...
        public virtual PdfLineAnnotation SetBorderStyle(PdfName style) {
        ...
        /// instance.
        /// </returns>
        public virtual PdfLineAnnotation SetDashPattern(PdfArray dashPattern) {
        ...
        /// <see cref="SetLineEndingStyles(PdfArray)"/>.
        /// </remarks>
        /// <returns>
        ...
        /// <list type="bullet">
        /// <item><description>
        /// <see cref="PdfName.Square"/>
        /// - A square filled with the annotation's interior color, if any;
        /// </description></item>
        /// <item><description>
        /// <see cref="PdfName.Circle"/>
        /// - A circle filled with the annotation's interior color, if any;
        /// </description></item>
        /// <item><description>
        /// <see cref="PdfName.Diamond"/>
        /// - A diamond shape filled with the annotation's interior color, if any;
        /// </description></item>
        /// <item><description>
        /// <see cref="PdfName.OpenArrow"/>
        /// - Two short lines meeting in an acute angle to form an open arrowhead;
        /// </description></item>
        /// <item><description>
        /// <see cref="PdfName.ClosedArrow"/>
        ...
        /// </description></item>
        /// <item><description>
        /// <see cref="PdfName.None"/>
        /// - No line ending;
        /// </description></item>
        /// <item><description>
        /// <see cref="PdfName.Butt"/>
        /// - A short line at the endpoint perpendicular to the line itself;
        /// </description></item>
        /// <item><description>
        /// <see cref="PdfName.ROpenArrow"/>
        /// - Two short lines in the reverse direction from
        /// <see cref="PdfName.OpenArrow"/>
        /// ;
        /// </description></item>
        /// <item><description>
        /// <see cref="PdfName.RClosedArrow"/>
        /// - A triangular closed arrowhead in the reverse direction from
        /// <see cref="PdfName.ClosedArrow"/>
        /// ;
        /// </description></item>
        /// <item><description>
        /// <see cref="PdfName.Slash"/>
        ...
        /// instance.
        /// </returns>
        public virtual PdfLineAnnotation SetLineEndingStyles(PdfArray lineEndingStyles) {
        ...
        /// instance.
        /// </returns>
        public virtual PdfLineAnnotation SetInteriorColor(PdfArray interiorColor) {
        ...
        /// instance.
        /// </returns>
        public virtual PdfLineAnnotation SetInteriorColor(float[] interiorColor) {
        ...
        public virtual float GetLeaderLineLength() {
            var n = GetPdfObject().GetAsNumber(PdfName.LL);
        ...
        /// instance.
        /// </returns>
        public virtual PdfLineAnnotation SetLeaderLineLength(float leaderLineLength) {
        ...
        public virtual float GetLeaderLineExtension() {
            var n = GetPdfObject().GetAsNumber(PdfName.LLE);
            return n == null ? 0 : n.FloatValue();
        }
        ...
        /// instance.
        /// </returns>
        public virtual PdfLineAnnotation SetLeaderLineExtension(float leaderLineExtension) {
        ...
        public virtual float GetLeaderLineOffset() {
            var n = GetPdfObject().GetAsNumber(PdfName.LLO);
            return n == null ? 0 : n.FloatValue();
        }
        ...
        public virtual bool GetContentsAsCaption() {
            var b = GetPdfObject().GetAsBoolean(PdfName.Cap);
        ...
        /// instance.
        /// </returns>
        public virtual PdfLineAnnotation SetContentsAsCaption(bool contentsAsCaption) {
        ...
        /// <see cref="PdfName.Inline"/>
        /// , meaning the caption
        /// is centered inside the line, and
        /// <see cref="PdfName.Top"/>
        ...
        /// instance.
        /// </returns>
        public virtual PdfLineAnnotation SetCaptionPosition(PdfName captionPosition) {
        ...
        /// instance.
        /// </returns>
        public virtual PdfLineAnnotation SetMeasure(PdfDictionary measure) {
        ...
        /// instance.
        /// </returns>
        public virtual PdfLineAnnotation SetCaptionOffset(PdfArray captionOffset) {
        ...
        /// instance.
        /// </returns>
        public virtual PdfLineAnnotation SetCaptionOffset(float[] captionOffset) {
