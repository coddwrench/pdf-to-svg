...
namespace IText.Kernel.Pdf.Annot {
    public class PdfRedactAnnotation : PdfMarkupAnnotation {
        ...
        /// instance.+
        /// </returns>
        public virtual PdfRedactAnnotation SetDefaultAppearance(PdfString appearanceString) {
            return (PdfRedactAnnotation)Put(PdfName.DA, appearanceString);
        }

        public virtual PdfRedactAnnotation SetDefaultAppearance(AnnotationDefaultAppearance
             da) {
            return SetDefaultAppearance(da.ToPdfString());
        }

        public virtual PdfRedactAnnotation SetOverlayText(PdfString text) {
        ...
        public virtual PdfRedactAnnotation SetRedactRolloverAppearance(PdfStream stream) {
        ...
        public virtual PdfRedactAnnotation SetRepeat(PdfBoolean repeat) {
        ...
        /// instance.
        /// </returns>
        public virtual PdfRedactAnnotation SetQuadPoints(PdfArray quadPoints) {
        ...
        /// instance.
        /// </returns>
        public virtual PdfRedactAnnotation SetInteriorColor(PdfArray interiorColor) {
        ...
        /// instance.
        /// </returns>
        public virtual PdfRedactAnnotation SetInteriorColor(float[] interiorColor) {
        ...
        /// instance.
        /// </returns>
        public virtual PdfRedactAnnotation SetJustification(int justification) {
