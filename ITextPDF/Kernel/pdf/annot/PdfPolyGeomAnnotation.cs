...
namespace IText.Kernel.Pdf.Annot {
    public abstract class PdfPolyGeomAnnotation : PdfMarkupAnnotation {
        [Obsolete(@", use iText.Kernel.Pdf.PdfName.Polygon instead.")]
        public static readonly PdfName Polygon = PdfName.Polygon;

        [Obsolete(@", use iText.Kernel.Pdf.PdfName.PolyLine instead.")]
        ...
        public virtual PdfPolyGeomAnnotation SetVertices(PdfArray vertices) {
            if (GetPdfObject().ContainsKey(PdfName.Path)) {
                LogManager.GetLogger(GetType()).Warn(LogMessageConstant.PATH_KEY_IS_PRESENT_VERTICES_WILL_BE_IGNORED
                    );
            }
            return (PdfPolyGeomAnnotation)Put(PdfName.Vertices, vertices);
        }

        public virtual PdfPolyGeomAnnotation SetVertices(float[] vertices) {
            if (GetPdfObject().ContainsKey(PdfName.Path)) {
                LogManager.GetLogger(GetType()).Warn(LogMessageConstant.PATH_KEY_IS_PRESENT_VERTICES_WILL_BE_IGNORED
                    );
            }
        ...
        public virtual PdfPolyGeomAnnotation SetLineEndingStyles(PdfArray lineEndingStyles) {
        ...
        public virtual PdfPolyGeomAnnotation SetMeasure(PdfDictionary measure) {
        ...
        /// instance
        /// </returns>
        public virtual PdfPolyGeomAnnotation SetPath(PdfArray path) {
            if (GetPdfObject().ContainsKey(PdfName.Vertices)) {
                LogManager.GetLogger(GetType()).Error(LogMessageConstant.IF_PATH_IS_SET_VERTICES_SHALL_NOT_BE_PRESENT
                    );
            }
        ...
        /// instance.
        /// </returns>
        public virtual PdfPolyGeomAnnotation SetBorderStyle(PdfDictionary borderStyle) {
        ...
        public virtual PdfPolyGeomAnnotation SetBorderStyle(PdfName style) {
        ...
        /// instance.
        /// </returns>
        public virtual PdfPolyGeomAnnotation SetDashPattern(PdfArray dashPattern) {
        ...
        /// instance.
        /// </returns>
        public virtual PdfPolyGeomAnnotation SetBorderEffect(PdfDictionary borderEffect) {
        ...
        /// instance.
        /// </returns>
        public virtual PdfPolyGeomAnnotation SetInteriorColor(PdfArray interiorColor) {
        ...
        /// instance.
        /// </returns>
        public virtual PdfPolyGeomAnnotation SetInteriorColor(float[] interiorColor) {
