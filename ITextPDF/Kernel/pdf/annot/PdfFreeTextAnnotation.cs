...
namespace IText.Kernel.Pdf.Annot {
    public class PdfFreeTextAnnotation : PdfMarkupAnnotation {
        ...
        public virtual PdfFreeTextAnnotation SetDefaultStyleString(PdfString defaultStyleString
            ) {
        ...
        /// instance.
        /// </returns>
        public virtual PdfFreeTextAnnotation SetDefaultAppearance(PdfString appearanceString
            ) {
            return (PdfFreeTextAnnotation)Put(PdfName.DA, appearanceString);
        }

        public virtual PdfFreeTextAnnotation SetDefaultAppearance(AnnotationDefaultAppearance
             da) {
        ...
        public virtual PdfFreeTextAnnotation SetCalloutLine(float[] calloutLine) {
            return SetCalloutLine(new PdfArray(calloutLine));
        }

        public virtual PdfFreeTextAnnotation SetCalloutLine(PdfArray calloutLine) {
        ...
        public virtual PdfFreeTextAnnotation SetLineEndingStyle(PdfName lineEndingStyle) {
        ...
        public virtual int GetJustification() {
            var q = GetPdfObject().GetAsNumber(PdfName.Q);
        ...
        /// instance.
        /// </returns>
        public virtual PdfFreeTextAnnotation SetJustification(int justification) {
        ...
        /// instance.
        /// </returns>
        public virtual PdfFreeTextAnnotation SetBorderStyle(PdfDictionary borderStyle) {
        ...
        public virtual PdfFreeTextAnnotation SetBorderStyle(PdfName style) {
        ...
        /// instance.
        /// </returns>
        public virtual PdfFreeTextAnnotation SetDashPattern(PdfArray dashPattern) {
        ...
        /// instance.
        /// </returns>
        public virtual PdfFreeTextAnnotation SetRectangleDifferences(PdfArray rect) {
        ...
        /// instance.
        /// </returns>
        public virtual PdfFreeTextAnnotation SetBorderEffect(PdfDictionary borderEffect) {
