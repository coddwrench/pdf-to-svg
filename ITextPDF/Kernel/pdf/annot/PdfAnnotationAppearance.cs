...
namespace IText.Kernel.Pdf.Annot {
    public class PdfAnnotationAppearance : PdfObjectWrapper<PdfDictionary> {
        ...
        public virtual PdfAnnotationAppearance SetState(PdfName stateName, PdfFormXObject state
            ) {
            GetPdfObject().Put(stateName, state.GetPdfObject());
            return this;
        }

        public virtual PdfAnnotationAppearance SetStateObject(PdfName stateName, PdfStream 
            state) {
