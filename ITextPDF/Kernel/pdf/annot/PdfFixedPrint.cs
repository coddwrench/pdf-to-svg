...
namespace IText.Kernel.Pdf.Annot {
    public class PdfFixedPrint : PdfObjectWrapper<PdfDictionary> {
        ...
        public virtual PdfFixedPrint SetMatrix(PdfArray matrix) {
            GetPdfObject().Put(PdfName.Matrix, matrix);
            return this;
        }

        public virtual PdfFixedPrint SetMatrix(float[] matrix) {
            GetPdfObject().Put(PdfName.Matrix, new PdfArray(matrix));
            return this;
        }

        public virtual PdfFixedPrint SetHorizontalTranslation(float horizontal) {
            GetPdfObject().Put(PdfName.H, new PdfNumber(horizontal));
            return this;
        }

        public virtual PdfFixedPrint SetVerticalTranslation(float vertical) {
