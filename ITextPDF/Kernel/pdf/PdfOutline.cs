...
namespace IText.Kernel.Pdf {
    ...
    public class PdfOutline {
        ...
        private IList<PdfOutline> children = new List<PdfOutline>();
        ...
        /// instead.
        /// </param>
        internal PdfOutline(string title, PdfDictionary content, PdfOutline parent) {
            this.title = title;
            this.content = content;
            this.parent = parent;
            pdfDoc = parent.pdfDoc;
        ...
        /// <see cref="PdfEncodings.UNICODE_BIG"/>
        /// encoding,
        /// <c>Title</c>
        /// key.
        /// </summary>
        ...
        public virtual void SetTitle(string title) {
            this.title = title;
            content.Put(PdfName.Title, new PdfString(title, PdfEncodings.UNICODE_BIG));
        }
        ...
        public virtual PdfOutline AddOutline(PdfOutline outline) {
            var newOutline = AddOutline(outline.GetTitle());
        ...
        public virtual void RemoveOutline() {
            ...
            var next = content.GetAsDictionary(PdfName.Next);
            var prev = content.GetAsDictionary(PdfName.Prev);
            if (prev != null) {
                if (next != null) {
        ...
        private bool IsOutlineRoot() {
            var outlineRoot = GetOutlineRoot();
