...
namespace IText.Kernel.Pdf.Tagging {
    public class PdfUserProperty : PdfObjectWrapper<PdfDictionary> {
        ...
        public virtual ValueType GetValueType() {
            var valObj = GetPdfObject().Get(PdfName.V);
            if (valObj == null) {
        ...
        public virtual string GetValueAsText() {
            var str = GetPdfObject().GetAsString(PdfName.V);
            return str != null ? str.ToUnicodeString() : null;
        }

        public virtual float? GetValueAsFloat() {
            var num = GetPdfObject().GetAsNumber(PdfName.V);
            return num != null ? num.FloatValue() : (float?)null;
        }
        ...
        public virtual string GetValueFormattedRepresentation() {
            var f = GetPdfObject().GetAsString(PdfName.F);
