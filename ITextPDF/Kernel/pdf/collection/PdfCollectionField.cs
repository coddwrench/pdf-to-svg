...
namespace IText.Kernel.Pdf.Collection {
    public class PdfCollectionField : PdfObjectWrapper<PdfDictionary> {
        ...
        protected internal PdfCollectionField(PdfDictionary pdfObject)
            : base(pdfObject) {
            var subType = pdfObject.GetAsName(PdfName.Subtype).GetValue();
            switch (subType) {
                case "D": {
                    this.subType = DATE;
                    break;
        ...
        /// <see cref="PdfBoolean">PDF boolean</see>
        /// value
        /// </returns>
        ...
        /// <returns>
        /// resulting
        /// <see cref="PdfObject">PDF object</see>
        /// </returns>
        public virtual PdfObject GetValue(string value) {
            switch (subType) {
                ...
                case NUMBER: {
                    return new PdfNumber(double.Parse(value.Trim(), CultureInfo.InvariantCulture));
                }
            }
