...
namespace IText.Kernel.Pdf.Navigation {
    ...
    public class PdfExplicitRemoteGoToDestination : PdfDestination {
        ...
        /// <see cref="PdfExplicitRemoteGoToDestination"/>
        /// </returns>
        public static PdfExplicitRemoteGoToDestination CreateXYZ(int pageNum, float left
        ...
        /// <see cref="PdfExplicitRemoteGoToDestination"/>
        /// </returns>
        public static PdfExplicitRemoteGoToDestination CreateFitR(int pageNum, float left
        ...
        /// <see cref="PdfExplicitRemoteGoToDestination"/>
        /// </returns>
        public static PdfExplicitRemoteGoToDestination CreateFitBH(int pageNum, float 
            top) {
        ...
        /// <see cref="PdfExplicitRemoteGoToDestination"/>
        /// </returns>
        public static PdfExplicitRemoteGoToDestination CreateFitBV(int pageNum, float 
            left) {
        ...
        /// <see cref="PdfExplicitDestination"/>
        /// </returns>
        public static PdfExplicitRemoteGoToDestination Create(int pageNum, PdfName type
            , float left, float bottom, float right, float top, float zoom) {
            return new PdfExplicitRemoteGoToDestination().Add(--pageNum).Add(type).Add(left
