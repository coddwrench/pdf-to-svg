...
namespace IText.Kernel.Pdf {
    public class WriterProperties {
        ...
        /// instance
        /// </returns>
        public virtual WriterProperties SetStandardEncryption(byte[] userPassword, byte[] ownerPassword
        ...
        /// instance
        /// </returns>
        public virtual WriterProperties SetPublicKeyEncryption(X509Certificate[] certs, int[] permissions
        ...
        /// instance
        /// </returns>
        public virtual WriterProperties UseDebugMode() {
            debugMode = true;
            return this;
        }
