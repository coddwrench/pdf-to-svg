...
namespace IText.Kernel.Pdf.Colorspace {
    ...
    public abstract class PdfShading : PdfObjectWrapper<PdfDictionary> {
        ...
        public class FunctionBased : PdfShading {
            ...
            /// from which this
            /// <see cref="PdfShading.FunctionBased"/>
            /// will be created
            /// </param>
            ...
            public virtual void SetDomain(float xmin, float xmax, float ymin, float ymax) {
                SetDomain(new PdfArray(new[] { xmin, xmax, ymin, ymax }));
            }
            ...
            public virtual PdfArray GetMatrix() {
                var matrix = GetPdfObject().GetAsArray(PdfName.Matrix);
                if (matrix == null) {
        ...
        public class Axial : PdfShading {
            ...
            public virtual void SetCoords(float x0, float y0, float x1, float y1) {
                SetCoords(new PdfArray(new[] { x0, y0, x1, y1 }));
            }
            ...
            /// </returns>
            public virtual PdfArray GetDomain() {
                var domain = GetPdfObject().GetAsArray(PdfName.Domain);
                if (domain == null) {
            ...
            public virtual void SetDomain(float t0, float t1) {
                SetDomain(new PdfArray(new[] { t0, t1 }));
            }
            ...
            public virtual PdfArray GetExtend() {
                var extend = GetPdfObject().GetAsArray(PdfName.Extend);
                if (extend == null) {
                    extend = new PdfArray(new[] { false, false });
                    SetExtend(extend);
                }
                return extend;
            }
            ...
            public virtual void SetExtend(bool extendStart, bool extendEnd) {
                SetExtend(new PdfArray(new[] { extendStart, extendEnd }));
            }
        ...
        public class Radial : PdfShading {
            ...
            public virtual void SetCoords(float x0, float y0, float r0, float x1, float y1, float r1) {
                SetCoords(new PdfArray(new[] { x0, y0, r0, x1, y1, r1 }));
            }
        ...
        public class FreeFormGouraudShadedTriangleMesh : PdfShading {
            ...
            /// from which this
            /// <see cref="PdfShading.FreeFormGouraudShadedTriangleMesh"/>
            /// will be created
            /// </param>
        ...
        public class LatticeFormGouraudShadedTriangleMesh : PdfShading {
            ...
            /// <param name="pdfStream">
            /// from which this
            /// <see cref="PdfShading.LatticeFormGouraudShadedTriangleMesh"/>
            /// will be created
            /// </param>
        ...
        public class CoonsPatchMesh : PdfShading {
            ...
            /// <param name="pdfStream">
            /// from which this
            /// <see cref="PdfShading.CoonsPatchMesh"/>
            /// will be created
            /// </param>
        ...
        public class TensorProductPatchMesh : PdfShading {
            ...
            /// <param name="pdfStream">
            /// from which this
            /// <see cref="PdfShading.TensorProductPatchMesh"/>
            /// will be created
            /// </param>
