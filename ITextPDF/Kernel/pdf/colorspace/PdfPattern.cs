...
namespace IText.Kernel.Pdf.Colorspace {
    ...
    public abstract class PdfPattern : PdfObjectWrapper<PdfDictionary> {
        ...
        public static PdfPattern GetPatternInstance(PdfDictionary pdfObject) {
            var type = pdfObject.GetAsNumber(PdfName.PatternType);
        ...
        public class Tiling : PdfPattern {
            ...
            public Tiling(Rectangle bbox, float xStep, float yStep, bool colored)
                ...
                GetPdfObject().Put(PdfName.PaintType, new PdfNumber(colored ? PaintType.COLORED : PaintType
                    .UNCOLORED));
            ...
            public virtual void SetTilingType(int tilingType) {
                if (tilingType != TilingType.CONSTANT_SPACING && tilingType != TilingType
                    .NO_DISTORTION && tilingType != TilingType.CONSTANT_SPACING_AND_FASTER_TILING) {
