...
namespace IText.Kernel.Pdf {
    public class PdfViewerPreferences : PdfObjectWrapper<PdfDictionary> {
        ...
        /// <see cref="PdfViewerPreferences"/>
        /// </returns>
        public virtual PdfViewerPreferences SetNonFullScreenPageMode(PdfViewerPreferencesConstants
             nonFullScreenPageMode) {
            switch (nonFullScreenPageMode) {
                case PdfViewerPreferencesConstants.USE_NONE: {
                    Put(PdfName.NonFullScreenPageMode, PdfName.UseNone);
                    break;
                }

                case PdfViewerPreferencesConstants.USE_OUTLINES: {
                    Put(PdfName.NonFullScreenPageMode, PdfName.UseOutlines);
                    break;
                }

                case PdfViewerPreferencesConstants.USE_THUMBS: {
                    Put(PdfName.NonFullScreenPageMode, PdfName.UseThumbs);
                    break;
                }

                case PdfViewerPreferencesConstants.USE_OC: {
        ...
        /// <see cref="PdfViewerPreferences"/>
        /// </returns>
        public virtual PdfViewerPreferences SetDirection(PdfViewerPreferencesConstants direction
            ) {
            switch (direction) {
                case PdfViewerPreferencesConstants.LEFT_TO_RIGHT: {
                    Put(PdfName.Direction, PdfName.L2R);
                    break;
                }

                case PdfViewerPreferencesConstants.RIGHT_TO_LEFT: {
        ...
        /// <see cref="PdfViewerPreferences"/>
        /// </returns>
        public virtual PdfViewerPreferences SetViewArea(PdfViewerPreferencesConstants pageBoundary
            ) {
        ...
        /// <see cref="PdfViewerPreferences"/>
        /// </returns>
        public virtual PdfViewerPreferences SetViewClip(PdfViewerPreferencesConstants pageBoundary
            ) {
        ...
        /// <see cref="PdfViewerPreferences"/>
        /// </returns>
        public virtual PdfViewerPreferences SetPrintArea(PdfViewerPreferencesConstants pageBoundary
            ) {
        ...
        /// <see cref="PdfViewerPreferences"/>
        /// </returns>
        public virtual PdfViewerPreferences SetPrintClip(PdfViewerPreferencesConstants pageBoundary
            ) {
        ...
        /// <see cref="PdfViewerPreferences"/>
        /// </returns>
        public virtual PdfViewerPreferences SetPrintScaling(PdfViewerPreferencesConstants printScaling
            ) {
            switch (printScaling) {
                case PdfViewerPreferencesConstants.NONE: {
                    Put(PdfName.PrintScaling, PdfName.None);
                    break;
                }

                case PdfViewerPreferencesConstants.APP_DEFAULT: {
        ...
        /// <see cref="PdfViewerPreferences"/>
        /// </returns>
        public virtual PdfViewerPreferences SetDuplex(PdfViewerPreferencesConstants duplex) {
            switch (duplex) {
                case PdfViewerPreferencesConstants.SIMPLEX: {
                    Put(PdfName.Duplex, PdfName.Simplex);
                    break;
                }

                case PdfViewerPreferencesConstants.DUPLEX_FLIP_SHORT_EDGE: {
                    Put(PdfName.Duplex, PdfName.DuplexFlipShortEdge);
                    break;
                }

                case PdfViewerPreferencesConstants.DUPLEX_FLIP_LONG_EDGE: {
        ...
        public virtual PdfViewerPreferences SetEnforce(PdfArray enforce) {
            for (var i = 0; i < enforce.Size(); i++) {
                var curEnforce = enforce.GetAsName(i);
                if (curEnforce == null) {
                ...
                if (PdfName.PrintScaling.Equals(curEnforce)) {
	                ...
	                var curPrintScaling = GetPdfObject().GetAsName(PdfName.PrintScaling);
        ...
        private PdfViewerPreferences SetPageBoundary(PdfViewerPreferencesConstants viewerPreferenceType
            , PdfViewerPreferencesConstants pageBoundary) {
            PdfName type = null;
            switch (viewerPreferenceType) {
                case PdfViewerPreferencesConstants.VIEW_AREA: {
                    type = PdfName.ViewArea;
                    break;
                }

                case PdfViewerPreferencesConstants.VIEW_CLIP: {
                    type = PdfName.ViewClip;
                    break;
                }

                case PdfViewerPreferencesConstants.PRINT_AREA: {
                    type = PdfName.PrintArea;
                    break;
                }

                case PdfViewerPreferencesConstants.PRINT_CLIP: {
            ...
            if (type != null) {
                switch (pageBoundary) {
                    case PdfViewerPreferencesConstants.MEDIA_BOX: {
                        Put(type, PdfName.MediaBox);
                        break;
                    }

                    case PdfViewerPreferencesConstants.CROP_BOX: {
                        Put(type, PdfName.CropBox);
                        break;
                    }

                    case PdfViewerPreferencesConstants.BLEED_BOX: {
                        Put(type, PdfName.BleedBox);
                        break;
                    }

                    case PdfViewerPreferencesConstants.TRIM_BOX: {
                        Put(type, PdfName.TrimBox);
                        break;
                    }

                    case PdfViewerPreferencesConstants.ART_BOX: {
