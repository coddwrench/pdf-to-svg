...
namespace IText.Kernel.Pdf.Canvas.Parser.ClipperLib {
  ...
  using cInt = Int32;
    ...
    public enum PolyFillType { EVEN_ODD, NON_ZERO, POSITIVE, NEGATIVE }

    public enum JoinType { BEVEL, ROUND, MITER }
    public enum EndType { CLOSED_POLYGON, CLOSED_LINE, OPEN_BUTT, OPEN_SQUARE, OPEN_ROUND }
    ...
    public const cInt hiRange = 0x7FFF;
        ...
        public virtual void Clear() {
            ...
            for (var i = 0; i < m_edges.Count; ++i) {
                for (var j = 0; j < m_edges[i].Count; ++j)
                    m_edges[i][j] = null;
                m_edges[i].Clear();
            }
            m_edges.Clear();
    ...
    public class Clipper : ClipperBase {
      ...
      //------------------------------------------------------------------------------
        ...
        private void ProcessHorizontal(TEdge horzEdge) {
            ...
            var IsOpen = horzEdge.OutIdx >= 0 && m_PolyOuts[horzEdge.OutIdx].IsOpen;
            ...
            for (;;) //loop through consec. horizontal edges
        {
                ...
                while (e != null) {
                    ...
                    if ((dir == Direction.LEFT_TO_RIGHT && e.Curr.X > horzRight) ||
                      (dir == Direction.RIGHT_TO_LEFT && e.Curr.X < horzLeft))
                        break;
        ...
        public static Paths MinkowskiSum(Path pattern, Paths paths, bool pathIsClosed) {
            ...
            c.Execute(ClipType.UNION, solution,
              PolyFillType.NON_ZERO, PolyFillType.NON_ZERO);
            return solution;
        }
        //------------------------------------------------------------------------------
    ...
    public class ClipperOffset {
        ...
        public void Execute(ref Paths solution, double delta) {
            ...
            if (delta > 0) {
                ...
                var r = Clipper.GetBounds(m_destPolys);
        ...
        public void Execute(ref PolyTree solution, double delta) {
            ...
            //now clean up 'corners' ...
            var clpr = new Clipper(Clipper.ioReverseSolution);
            clpr.AddPaths(m_destPolys, PolyType.SUBJECT, true);
            if (delta > 0) {
                clpr.Execute(ClipType.UNION, solution,
                  PolyFillType.POSITIVE, PolyFillType.POSITIVE);
