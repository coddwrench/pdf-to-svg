...
namespace IText.Kernel.Pdf.Canvas.Parser.Data {
    ...
    public class ImageRenderInfo : AbstractRenderInfo {
        ...
        public ImageRenderInfo(Stack<CanvasTag> canvasTagHierarchy, CanvasGraphicsState gs, Matrix ctm, PdfStream 
            ...
            this.ctm = ctm;
            image = new PdfImageXObject(imageStream);
        ...
        /// <see cref="PdfImageXObject.GetImageBytes(bool)"/>
        /// , these image bytes
        ...
        /// <see cref="PdfObjectWrapper{T}.GetPdfObject()"/>
        /// method;
        /// </description></item>
        /// <item><description>convert image to
        /// <see cref="System.Drawing.Bitmap"/>
        /// with
        /// <see cref="PdfImageXObject.GetBufferedImage()"/>
        /// ;
        /// </description></item>
        /// </list>
        /// </remarks>
        /// <returns>
        /// the
        /// <see cref="PdfImageXObject">image</see>
        /// </returns>
