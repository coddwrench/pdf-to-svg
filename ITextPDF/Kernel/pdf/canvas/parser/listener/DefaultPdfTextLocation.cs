...
namespace IText.Kernel.Pdf.Canvas.Parser.Listener {
    ...
    public class DefaultPdfTextLocation : IPdfTextLocation {
        ...
        public virtual DefaultPdfTextLocation SetRectangle(Rectangle rectangle
            ) {
        ...
        public virtual DefaultPdfTextLocation SetText(string text) {
            this.text = text;
            return this;
        }
        ...
        public virtual DefaultPdfTextLocation SetPageNr(int pageNr) {
            this.pageNr = pageNr;
            return this;
        }
    }
