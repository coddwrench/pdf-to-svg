...
namespace IText.Kernel.Pdf.Canvas.Parser {
    ...
    public class ParserGraphicsState : CanvasGraphicsState {
        ...
        internal ParserGraphicsState(ParserGraphicsState source)
            : base(source) {
        ...
        /// <see cref="CanvasGraphicsState.GetCtm()"/>
        /// ).
        /// </remarks>
        ...
        public virtual void SetClippingPath(Path clippingPath) {
            var pathCopy = new Path(clippingPath);
            pathCopy.CloseAllSubpaths();
