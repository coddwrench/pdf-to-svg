...
namespace IText.Kernel.Pdf.Canvas.Wmf {
    ...
    public class MetaFont : MetaObject {
        internal static readonly string[] fontNames = { "Courier", "Courier-Bold", "Courier-Oblique", 
        ...
        internal FontProgram font;

        internal FontEncoding encoding;
        ...
        public virtual void Init(InputMeta @in) {
            ...
            try {
                faceName = JavaUtil.GetStringForBytes(name, 0, k, "Cp1252");
            }
            catch (ArgumentException) {
                faceName = JavaUtil.GetStringForBytes(name, 0, k);
            }
        ...
        public virtual FontProgram GetFont() {
            ...
            var ff2 = FontProgramFactory.CreateRegisteredFont(faceName, ((italic != 0) ? FontStyles.ITALIC : 0
                    ...
                    if (faceName.Contains("arial black")) {
                        ...
                        if (faceName.Contains("times") || faceName.Contains("ms serif") || faceName.Contains("roman")) {
                            ...
                            if (faceName.Contains("symbol")) {
                                ...
                                var pitch = pitchAndFamily & 3;
                                var family = (pitchAndFamily >> 4) & 7;
                                switch (family) {
                                    case FF_MODERN: {
                                        fontName = fontNames[MARKER_COURIER + italic + bold];
                                        break;
