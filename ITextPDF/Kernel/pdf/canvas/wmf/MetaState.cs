...
namespace IText.Kernel.Pdf.Canvas.Wmf {
    ...
    public class MetaState {
            ...
            switch (obj.GetObjectType()) {
                case MetaObject.META_BRUSH: {
                    ...
                    if (style == MetaBrush.BS_SOLID) {
                        var color = currentBrush.GetColor();
        ...
        /// <see cref="PdfCanvasConstants.LineJoinStyle.MITER"/>
        /// if lineJoin isn't 0.
        /// </summary>
        ...
        /// <summary>
        /// Sets the line join style to
        /// <see cref="PdfCanvasConstants.LineJoinStyle.ROUND"/>
        /// if lineJoin is 0.
        /// </summary>
        /// <param name="cb">PdfCanvas to set the line join style</param>
