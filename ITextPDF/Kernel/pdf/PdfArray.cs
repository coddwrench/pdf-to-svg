...
namespace IText.Kernel.Pdf {
    ...
    public class PdfArray : PdfObject, IEnumerable<PdfObject> {
        ...
        /// <seealso cref="IList.Add(int, System.Object)"/>
        ...
        /// <seealso cref="IList.Set(int, System.Object)"/>
        ...
        /// <seealso ICollectionions.ICollection{E})"/>
        ...
        /// <seealso cref="IList.JRemoveAt(int)"/>
        ...
        /// <seealso cref="IList.Remove(System.Object)"/>
        ...
        /// <seealso cref="IList.IndexOf(System.Object)"/>
        ...
        /// <seealso cref="IList.SubList(int, int)"/>
        ...
        public override string ToString() {
            ...
            foreach (var entry in list) {
                var indirectReference = entry.GetIndirectReference();
        ...
        public virtual PdfArray GetAsArray(int index) {
            var direct = Get(index, true);
            if (direct != null && direct.GetObjectType() == ARRAY) {
        ...
        public virtual PdfDictionary GetAsDictionary(int index) {
            var direct = Get(index, true);
            if (direct != null && direct.GetObjectType() == DICTIONARY) {
        ...
        public virtual PdfStream GetAsStream(int index) {
            var direct = Get(index, true);
            if (direct != null && direct.GetObjectType() == STREAM) {
        ...
        public virtual PdfNumber GetAsNumber(int index) {
            var direct = Get(index, true);
            if (direct != null && direct.GetObjectType() == NUMBER) {
        ...
        public virtual PdfName GetAsName(int index) {
            var direct = Get(index, true);
            if (direct != null && direct.GetObjectType() == NAME) {
        ...
        public virtual PdfString GetAsString(int index) {
            var direct = Get(index, true);
            if (direct != null && direct.GetObjectType() == STRING) {
        ...
        public virtual PdfBoolean GetAsBoolean(int index) {
            var direct = Get(index, true);
            if (direct != null && direct.GetObjectType() == BOOLEAN) {
        ...
        public virtual Rectangle ToRectangle() {
            try {
                var x1 = GetAsNumber(0).FloatValue();
                var y1 = GetAsNumber(1).FloatValue();
                var x2 = GetAsNumber(2).FloatValue();
                var y2 = GetAsNumber(3).FloatValue();
                float llx;
                float lly;
                float urx;
                float ury;
        ...
        public virtual float[] ToFloatArray() {
            try {
                var rslt = new float[Size()];
                for (var k = 0; k < rslt.Length; ++k) {
