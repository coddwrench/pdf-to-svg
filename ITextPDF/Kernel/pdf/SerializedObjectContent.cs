...
namespace IText.Kernel.Pdf {
    internal class SerializedObjectContent {
        ...
        internal SerializedObjectContent(byte[] serializedContent) {
            ...
            hash = CalculateHash(serializedContent);
        }

        public override bool Equals(object obj) {
            return obj is SerializedObjectContent && GetHashCode() == obj.GetHashCode() && JavaUtil.ArraysEquals
                (serializedContent, ((SerializedObjectContent)obj).serializedContent);
        }
