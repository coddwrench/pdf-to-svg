...
namespace IText.Kernel.Pdf {
    public class PdfBoolean : PdfPrimitiveObject {
        public static readonly PdfBoolean TRUE = new PdfBoolean(true, true);

        public static readonly PdfBoolean FALSE = new PdfBoolean(false, true);
        ...
        protected internal override void CopyContent(PdfObject from, PdfDocument document) {
            ...
            var @bool = (PdfBoolean)from;
            value = @bool.value;
        }

        public override bool Equals(object obj) {
            return this == obj || obj != null && GetType() == obj.GetType() && value == ((PdfBoolean)
                obj).value;
        }
        ...
        public static PdfBoolean ValueOf(bool value) {
            return value ? TRUE : FALSE;
        }
    }
}
