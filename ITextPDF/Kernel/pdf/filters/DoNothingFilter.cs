...
namespace IText.Kernel.Pdf.Filters {
    ...
    public class DoNothingFilter : IFilterHandler {
        ...
        [Obsolete(@"Will be removed in 7.2. Used as a crutch iniText.Kernel.Pdf.Xobject.PdfImageXObject.GetImageBytes() implementation. Now this method does not needed. If the user has been used it, then the same approach can be reached with nested class."
            )]
