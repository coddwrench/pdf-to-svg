...
namespace IText.Kernel.Pdf {
    public class PdfIndirectReference : PdfObject, IComparable<PdfIndirectReference> {
        ...
        protected internal PdfObject refersTo;
        ...
        /// </remarks>
        protected internal int objectStreamNumber;
        ...
        /// </remarks>
        protected internal long offsetOrIndex;
        ...
        public virtual PdfObject GetRefersTo(bool recursively)
        {
	        ...
	        var currentRefersTo = GetRefersTo(false);
	        for (var i = 0; i < LENGTH_OF_INDIRECTS_CHAIN; i++) {
		        if (currentRefersTo is PdfIndirectReference) {
        ...
        public override bool Equals(object o) {
            ...
            var that = (PdfIndirectReference)o;
            var documentsEquals = pdfDocument == that.pdfDocument;
            if (!documentsEquals) {
        ...
        private int ComparePdfDocumentLinks(PdfIndirectReference toCompare)
        {
	        ...
	        var thisDocumentId = pdfDocument.GetDocumentId();
	        var documentIdToCompare = toCompare.pdfDocument.GetDocumentId();
