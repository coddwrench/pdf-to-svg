...
namespace IText.Kernel.Pdf {
    public abstract class PdfPrimitiveObject : PdfObject {
        protected internal byte[] content;
        ...
        protected internal override void CopyContent(PdfObject from, PdfDocument document) {
            ...
            var @object = (PdfPrimitiveObject)from;
            if (@object.content != null) {
                content = JavaUtil.ArraysCopyOf(@object.content, @object.content.Length);
            }
        }

        protected internal virtual int CompareContent(PdfPrimitiveObject o) {
            for (var i = 0; i < Math.Min(content.Length, o.content.Length); i++) {
