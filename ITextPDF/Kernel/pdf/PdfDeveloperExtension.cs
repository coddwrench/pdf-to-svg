...
namespace IText.Kernel.Pdf {
    ...
    public class PdfDeveloperExtension {
        ...
        public static readonly PdfDeveloperExtension ADOBE_1_7_EXTENSIONLEVEL3 = new PdfDeveloperExtension
            (PdfName.ADBE, PdfName.Pdf_Version_1_7, 3);

        /// <summary>An instance of this class for ETSI 1.7 Extension level 2.</summary>
        public static readonly PdfDeveloperExtension ESIC_1_7_EXTENSIONLEVEL2 = new PdfDeveloperExtension
            (PdfName.ESIC, PdfName.Pdf_Version_1_7, 2);

        /// <summary>An instance of this class for ETSI 1.7 Extension level 5.</summary>
        public static readonly PdfDeveloperExtension ESIC_1_7_EXTENSIONLEVEL5 = new PdfDeveloperExtension
