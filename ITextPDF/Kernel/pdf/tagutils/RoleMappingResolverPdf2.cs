...
namespace IText.Kernel.Pdf.Tagutils {
    internal class RoleMappingResolverPdf2 : IRoleMappingResolver {
        ...
        internal RoleMappingResolverPdf2(string role, PdfNamespace @namespace, PdfDocument document) {
            currRole = PdfStructTreeRoot.ConvertRoleToPdfName(role);
            currNamespace = @namespace;
            var defaultNsName = StandardNamespaces.GetDefault();
            var defaultNsRoleMap = document.GetStructTreeRoot().GetRoleMap();
            defaultNamespace = new PdfNamespace(defaultNsName).SetNamespaceRoleMap(defaultNsRoleMap);
        ...
        public virtual bool CurrentRoleIsStandard() {
            var roleStrVal = currRole.GetValue();
            var stdRole17 = StandardNamespaces.PDF_1_7.Equals(currNamespace.GetNamespaceName()) && StandardNamespaces
                .RoleBelongsToStandardNamespace(roleStrVal, StandardNamespaces.PDF_1_7);
            var stdRole20 = StandardNamespaces.PDF_2_0.Equals(currNamespace.GetNamespaceName()) && StandardNamespaces
        ...
        public virtual bool ResolveNextMapping() {
            ...
            var currNsRoleMap = currNamespace.GetNamespaceRoleMap();
            ...
            if (mapping.IsName()) {
                ...
                if (mapping.IsArray()) {
                    ...
                    var mappingArr = (PdfArray)mapping;
