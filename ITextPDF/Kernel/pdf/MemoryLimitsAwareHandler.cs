...
namespace IText.Kernel.Pdf {
    ...
    public class MemoryLimitsAwareHandler {
        ...
        public virtual bool IsMemoryLimitsAwarenessRequiredOnDecompression(PdfArray filters) {
            var filterSet = new HashSet<PdfName>();
            for (var index = 0; index < filters.Size(); index++) {
                var filterName = filters.GetAsName(index);
        ...
        internal virtual MemoryLimitsAwareHandler ConsiderBytesOccupiedByDecompressedPdfStream(long
             numOfOccupiedBytes) {
        ...
        /// instance.
        /// </returns>
        internal virtual MemoryLimitsAwareHandler BeginDecompressedPdfStreamProcessing() {
        ...
        /// </returns>
        /// <seealso cref="MemoryLimitsAwareException"/>
        internal virtual MemoryLimitsAwareHandler EndDecompressedPdfStreamProcessing() {
