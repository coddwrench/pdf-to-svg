...
namespace IText.Kernel.Geom {
    ...
    public class Vector {
        ...
        private readonly float[] vals = { 0, 0, 0 };
        ...
        public virtual Vector Cross(Matrix by) {
            var x = vals[I1] * by.Get(Matrix.I11) + vals[I2] * by.Get(Matrix.I21) + vals[I3] * by.Get(Matrix.I31);
            var y = vals[I1] * by.Get(Matrix.I12) + vals[I2] * by.Get(Matrix.I22) + vals[I3] * by.Get(Matrix.I32);
            var z = vals[I1] * by.Get(Matrix.I13) + vals[I2] * by.Get(Matrix.I23) + vals[I3] * by.Get(Matrix.I33);
        ...
        public virtual Vector Subtract(Vector v) {
            var x = vals[I1] - v.vals[I1];
            var y = vals[I2] - v.vals[I2];
            var z = vals[I3] - v.vals[I3];
            return new Vector(x, y, z);
        }
        ...
        public virtual Vector Cross(Vector with) {
            var x = vals[I2] * with.vals[I3] - vals[I3] * with.vals[I2];
            var y = vals[I3] * with.vals[I1] - vals[I1] * with.vals[I3];
            var z = vals[I1] * with.vals[I2] - vals[I2] * with.vals[I1];
            return new Vector(x, y, z);
        }
