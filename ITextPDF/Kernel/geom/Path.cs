...
namespace IText.Kernel.Geom {
    ...
    public class Path {
        ...
        public virtual void MoveTo(float x, float y) {
            ...
            var lastSubpath = subpaths.Count > 0 ? subpaths[subpaths.Count - 1] : null;
        ...
        public virtual void CurveTo(float x1, float y1, float x2, float y2, float x3, float y3) {
            ...
            var thirdPoint = new Point(x2, y2);
            var fourthPoint = new Point(x3, y3);
        ...
        public virtual void CloseSubpath() {
            if (!IsEmpty()) {
                var lastSubpath = GetLastSubpath();
                lastSubpath.SetClosed(true);
                var startPoint = lastSubpath.GetStartPoint();
