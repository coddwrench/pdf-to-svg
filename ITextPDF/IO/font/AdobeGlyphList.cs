    ...
    public class AdobeGlyphList {
        ...
        static AdobeGlyphList() {
            ...
            try {
                ...
                resource.Dispose();
                resource = null;
                var s = PdfEncodings.ConvertToString(stream.ToArray(), null);
                ...
                while (tk.HasMoreTokens()) {
                    ...
                    var name = t2.NextToken();
                    if (!t2.HasMoreTokens()) {
                        continue;
                    }
                    var hex = t2.NextToken();
                ...
                Console.Error.WriteLine("AdobeGlyphList.txt loading error: " + e.Message);
            }
            finally {
                if (resource != null) {
                    try {
