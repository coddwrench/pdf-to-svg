...
namespace IText.IO.Font
{
	public abstract class FontProgram
	{
		...
		public IDictionary<int, Glyph> СodeToGlyph { get; internal set; } = new Dictionary<int, Glyph>();
		...
		{
			return Math.Max(СodeToGlyph.Count, UnicodeToGlyph.Count);
		}
		...
		{
			return СodeToGlyph.Get(charCode);
		}
		...
		protected internal virtual void FixSpaceIssue()
		{
			...
			if (space != null)
			{
				СodeToGlyph.Put(space.GetCode(), space);
			}
		}
