    ...
    public class GsubLookupType2 : OpenTableLookup {
        ...
        public override bool TransformOne(GlyphLine line) {
            ...
            if (!openReader.IsSkip(g.GetCode(), lookupFlag)) {
                var substSequence = substMap.Get(g.GetCode());
        ...
        protected internal override void ReadSubTable(int subTableLocation) {
            ...
            var substFormat = openReader.rf.ReadUnsignedShort();
            if (substFormat == 1) {
                var coverage = openReader.rf.ReadUnsignedShort();
                var sequenceCount = openReader.rf.ReadUnsignedShort();
                var sequenceLocations = openReader.ReadUShortArray(sequenceCount, subTableLocation);
