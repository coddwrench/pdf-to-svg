...
namespace  IText.IO.Util {
    ...
    public sealed class TextUtil {
        ...
        public static char[] ConvertFromUtf32(int codePoint) {
            ...
            codePoint -= 0x10000;
            return new[] {(char) (codePoint / 0x400 + 0xd800), (char) (codePoint % 0x400 + 0xdc00)};
        }
        ...
        public static bool IsWhiteSpace(int unicode) {
            ...
            var category = GetUnicodeCategory(unicode);
        ...
        static int[] ignorableCodePoints = {
        ...
        private static UnicodeCategory GetUnicodeCategory(int unicodeCodePoint) {
            var category = unicodeCodePoint <= char.MaxValue
