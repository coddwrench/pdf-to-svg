...
namespace  IText.IO.Colors {
    ...
    public class IccProfile {
        ...
        public static IccProfile GetInstance(byte[] data, int numComponents) {
            ...
            // invalid ICC
            if (nc != numComponents) {
                throw new IOException(IOException.IccProfileContains0ComponentsWhileImageDataContains1Components
        ...
        public static string GetIccColorSpaceName(byte[] data) {
            string colorSpace;
            try {
                colorSpace = JavaUtil.GetStringForBytes(data, 16, 4, "US-ASCII");
            }
        ...
        public static string GetIccDeviceClass(byte[] data) {
            string deviceClass;
            try {
                deviceClass = JavaUtil.GetStringForBytes(data, 12, 4, "US-ASCII");
            }
            catch (ArgumentException e) {
                throw new IOException(IOException.InvalidIccProfile, e);
            }
