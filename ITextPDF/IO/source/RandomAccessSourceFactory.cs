...
namespace  IText.IO.Source
{
	...
	public sealed class RandomAccessSourceFactory
	{
        ...
        /// , where applicable
        /// </summary>
        [Obsolete(@"Will be removed in iText 7.2. The field makes sense only in Java.")]
        ...
        /// </param>
        /// <returns>this object (this allows chaining of method calls)</returns>
        [Obsolete(@"Will be removed in iText 7.2. The method makes sense only in Java.")]
		...
		{
            var sources = new IRandomAccessSource[ranges.Length / 2];
		...
		{
			var stream = ResourceUtil.GetResourceStream(filename);
			if (stream == null)
			{
