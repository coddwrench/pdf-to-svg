...
namespace  IText.IO {
    ...
    public sealed class LogMessageConstant {
        ...
        [Obsolete(@"Logging this case has been deprecated The constant will be removed in 7.2.")]
        ...
        [Obsolete(@"Moved into cleanup module The constant will be removed in 7.2.")]
        ...
        [Obsolete(@"Use XREF_ERROR_WHILE_READING_TABLE_WILL_BE_REBUILT instead. The constant will be removed in 7.2."
            )]
